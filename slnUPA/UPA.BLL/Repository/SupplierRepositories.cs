...
{
    public class SupplierRepositories : ISupplierService
    {
        private UPAModel _context;


        public SupplierRepositories(UPAModel context)
        {
            _context = context;
        }
        ...
        public IEnumerable<IndexSupplierVM.GetData> ListSuppliers()
        {
        ...
        public IEnumerable<IndexSupplierVM.GetData> SortSuppliers(SortSupplierVM sortObj)
        {
            ...
            return (IEnumerable<IndexSupplierVM.GetData>)lstSuppliers;
        }
